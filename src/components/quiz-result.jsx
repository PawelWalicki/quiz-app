    ...
    return (
        <div className="fixed inset-0 z-50 flex justify-center items-center">
            ...
            <div className="relative bg-white bg-opacity-90 border-2 border-blue-400 shadow-lg rounded-lg p-8 max-w-sm w-full flex flex-col items-center">
                ...
                <p className="mb-2">
                    Correct answers: <span className="font-bold">{quizResult.numberOfCorrectAnswers}</span>
                </p>
                <p className="mb-6">
                    Number of questions: <span className="font-bold">{quizResult.numberOfQuestions}</span>
                </p>
                <Link href={`/`}>
                    <button
